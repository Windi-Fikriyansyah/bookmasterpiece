            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5 p-lg-6">
                    ...
                    <h2 class="fw-bold mb-2">
                        3. Link Akses Aplikasi BONUS
                        <span class="text-primary">Book Image Masterpiece”</span>
                    </h2>
                    ...
                    {{-- Tombol Akses --}}
                    <a href="https://gemini.google.com/share/97566163629f" target="_blank"
                        class="btn btn-primary btn-lg px-4 py-3 d-inline-flex align-items-center gap-2 mb-5">
                        <i class="ti ti-palette fs-4"></i>
                        <span class="fw-semibold">
                            Klik di sini untuk mengakses Image Cover Masterpiece
                        </span>
                    </a>
