            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5 p-lg-6">
                    ...
                    <h2 class="fw-bold mb-2">
                        ...
                        <span class="text-primary">Storybook Masterpiece”</span>
                    </h2>
